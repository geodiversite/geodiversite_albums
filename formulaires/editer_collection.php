 ...
 */
function formulaires_editer_collection_identifier_dist($id_collection = 'new', $retour = '', $associer_objet = '', $lier_trad = 0, $config_fonc = '', $row = [], $hidden = '') {
	return serialize([intval($id_collection), $associer_objet]);
}

/**
 * Declarer les champs postes et y integrer les valeurs par defaut
 */
function formulaires_editer_collection_charger_dist($id_collection = 'new', $retour = '', $associer_objet = '', $lier_trad = 0, $config_fonc = '', $row = [], $hidden = '') {
 ...
 */
function formulaires_editer_collection_verifier_dist($id_collection = 'new', $retour = '', $associer_objet = '', $lier_trad = 0, $config_fonc = '', $row = [], $hidden = '') {
	return formulaires_editer_objet_verifier('collection', $id_collection, ['titre']);
}

/**
 * Traiter les champs postes
 */
function formulaires_editer_collection_traiter_dist($id_collection = 'new', $retour = '', $associer_objet = '', $lier_trad = 0, $config_fonc = '', $row = [], $hidden = '') {
