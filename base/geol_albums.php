 ...
 */
function geol_albums_declarer_tables_interfaces($interfaces) {
 ...
 */
function geol_albums_declarer_tables_objets_sql($tables) {

	$tables['spip_collections'] = [
		'type' => 'collection',
		'principale' => 'oui',
		'field' => [
 ...
 */
function geol_albums_declarer_tables_auxiliaires($tables) {

	$tables['spip_collections_liens'] = [
		'field' => [
