 ...
 */
function formulaires_editer_collection_identifier_dist(
	$id_collection = 'new',
	$retour = '',
	$associer_objet = '',
	$lier_trad = 0,
 ...
 */
function formulaires_editer_collection_charger_dist(
	$id_collection = 'new',
	$retour = '',
	$associer_objet = '',
	$lier_trad = 0,
 ...
 */
function formulaires_editer_collection_verifier_dist(
	$id_collection = 'new',
	$retour = '',
	$associer_objet = '',
	$lier_trad = 0,
 ...
 */
function formulaires_editer_collection_traiter_dist(
	$id_collection = 'new',
	$retour = '',
	$associer_objet = '',
	$lier_trad = 0,
	...
	if ($res['id_collection'] != $id_collection) {
		$res['redirect'] = $retour ? parametre_url($retour, 'id_collection', $res['id_collection']) : parametre_url(
			self(),
			'id_collection',
			$res['id_collection']
		);
